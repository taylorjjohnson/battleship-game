requirejs(['lib/socket.io', 'lib/howler', 'lib/processing'], function (socketIO) {
    ...
    function sketchProcess(processing) {
        ...
        processing.setup = function () {
            ...
            tabletopImg = processing.loadImage(imagesDir + 'tabletop.jpg')
            ...
            processing.frameRate(48); //framerate set to 48 to match the 48 frames in the explosion sprite
        };
        ...
        processing.draw = function () {
            if (me.gameMenu) {
                ...
                //background
                processing.image(tabletopImg, 0, 0, width, height);
